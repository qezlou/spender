...
if __name__ == "__main__":
    ...
    # data loaders
    trainloader = instrument.get_data_loader(args.dir, tag="variable", which="train", batch_size=args.batch_size, shuffle=True)
    validloader = instrument.get_data_loader(args.dir, tag="variable", which="valid", batch_size=args.batch_size)
